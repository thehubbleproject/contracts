...
contract TestBLS {
    ...
    function isOnCurveG1CompressedGasCost(uint256[2] calldata point)
        external
        returns (uint256)
    {
        uint256 g = gasleft();
    ...
    function isOnCurveG2CompressedGasCost(uint256[4] calldata point)
        external
        returns (uint256)
    {
        uint256 g = gasleft();
    ...
    function isOnCurveG2GasCost(uint256[2] calldata point)
        external
        returns (uint256)
    {
        uint256 g = gasleft();
